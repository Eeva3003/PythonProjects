...
class InternetSpeedTwitterBot:
    ...
    def tweet_at_provider(self):
        ...
        tweet = f"Hey Internet Provider, why is my internet speed {self.down}down/{self.up}up when I pay for {P_DOWN}down/{P_UP}up?"
